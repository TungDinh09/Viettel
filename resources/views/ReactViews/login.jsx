      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-32 lg:px-8 ">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" action="#" method="POST">
            ...
            <div>
              <div className="flex items-center justify-between">
                <label htmlFor="password" className="block text-sm font-medium leading-6 text-pink-600">
                  Password
                </label>
                <div className="text-sm">
                  <a href="#" className="font-semibold text-rose-600 hover:text-zinc-950 ">
                    Forgot password?
                  </a>
                </div>
              </div>
          ...
          <div className="text-sm mt-3 items-center mx-auto">
                  <a href="#" className="font-semibold hover-trans text-rose-600 hover:text-zinc-950 ">
